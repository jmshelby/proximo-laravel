...
POST /ajax/message/position
	- Set the current/initial geo location
	@params(form): latitude, longitude
	@returns: json, standard

GET  /ajax/message/position
	- Get last position that was set/fetched/broadcasted
	@returns: json, standard

[ANY] /ajax/message/fetch
	- Get messages in your context; includes messages posted by you
	@params(form): latitude, longitude; (both optional, will use last set location)
	@returns: json, standard (response contains array of all messages)

[ANY] /ajax/message/broadcast
	- Get messages in your context; includes messages posted by you
	@params(form): message, latitude, longitude; (lat/long optional, will use las set location)
	@returns: json, standard (response contains the new message posted)
