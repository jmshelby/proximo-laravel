...
class GeoNearCommandMacro implements ScopeInterface
{
	...
	{
		$builder->macro('geoNear', function(Builder $builder, $lat, $long, $minDistance = null, $maxDistance = null)
		{
			return $this->macro_geoNear($builder, $lat, $long, $minDistance, $maxDistance);
		});
	}
