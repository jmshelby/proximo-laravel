...
/*
	...
	{
        return $this->hasMany('Proximo\Entities\Player\PoolActivity');
	}

	// Many Heart Aquisition Actions/Activity
	public function heartActivity()
	{
        return $this->hasMany('Proximo\Entities\Player\HeartActivity');
	}

	// Many Heart Transactions (giving hearts to another player)
	public function transactions()
	{
        return $this->hasMany('Proximo\Entities\Player\Transaction');
	}

	// Many Receiving Heart Transactions (receiving hearts from player)
	public function receivingTransactions()
	{
        return $this->hasMany('Proximo\Entities\Player\Transaction','receiving_player_id');
	}

	// Many Dividends Received
	public function dividends()
	{
        return $this->hasMany('Proximo\Entities\Player\Transaction\Dividend','receiving_player_id');
	}

	// Many Dividends Given As Pool Donor
	public function dividendsFromDonation()
	{
        return $this->hasMany('Proximo\Entities\Player\Transaction\Dividend', 'donor_player_id');
	}

	// Many Dividends Given As Result of me spending a heart on the donor
	public function dividendsFromHeartDonation()
	{
        return $this->hasMany('Proximo\Entities\Player\Transaction\Dividend', 'heart_donor_player_id');
	}
